...
const InquireAboutProperty = () => {
  return (
    <div className="flex gap-10 xl:gap-20 2xl:gap-[100px] items-start">
      <CommonHeading
        title="Inquire About Seaside Serenity Villa"
        description={description}
        className="w-[591px]"
      />
      <div className="flex-1 flex flex-col border border-gray15 rounded-xl p-5 xl:p-10 2xl:p-[50px] gap-5 xl:gap-10 2xl:gap-[50px]">
        <form className="grid grid-cols-1 lg:grid-cols-2 gap-5 xl:gap-[30px]">
          ...
          <div className="col-span-2 flex flex-col gap-[10px] xl:gap-[14px] 2xl:gap-4">
            ...
            <div className="flex items-center gap-3 bg-gray10 text-[#ffffff90] rounded-lg 2xl:py-6 2xl:px-5">
