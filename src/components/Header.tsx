...
const Header = () => {
  const { activePage, setActivePage, isDropDown, handleDropDown } =
    useAppState();
  return (
    <div className="bg-gray10 border-b-2 border-gray15">
      ...
      <div className="text-white h-[99px] flex items-center justify-between px-4 sm:px-10 md:px-20 2xl:px-[10.125rem] relative">
        ...
        <nav
          className={`${
            isDropDown ? "left-0 lg:left-full" : "left-full"
        ...
        <button className="block lg:hidden" onClick={handleDropDown}>
